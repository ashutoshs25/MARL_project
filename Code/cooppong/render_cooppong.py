...
Apexagent = ApexTrainer(env=env_name, config=config)
...
for agent in env.agent_iter():
    ...
    if done:
        ...
        action, _, _ = Apexagent.get_policy("policy_0").compute_single_action(observation)
...
print(reward_sum)
frame_list[0].save("out_cooppong_new.gif", save_all=True, append_images=frame_list[1:], duration=3, loop=0)
